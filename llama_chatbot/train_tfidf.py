...
def train_tfidf(corpus_path: str = os.path.join(DATA_DIR, "corpus.csv")) -> None:
    ...
    try:
        ...
        # Сохраняем tfidf_metadata.json (чтобы загрузить позже в tfidf_retriever)
        with open(os.path.join(DATA_DIR, "tfidf_metadata.json"), "w", encoding="utf-8") as f:
            json.dump(metadata, f, ensure_ascii=False, indent=2)

        logger.info("TF-IDF метаданные успешно сохранены")
        ...
        logger.info("TF-IDF векторайзер иматрица успешно сохранена")
